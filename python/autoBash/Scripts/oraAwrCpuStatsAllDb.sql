...
SELECT '|krn,'||i.host_name||','||snap_id||','||u.instance_name||','||to_char(end_interval_time,'YYYY-MM-DD HH24:MI')||','||round((fgcpu+bgcpu)*1.1/(DELTA*1000000),2)
FROM fgbgcpu u,v$instance i
